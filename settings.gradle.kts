...
include(":data:audio-asset")
include(":data:audio-asset:test-fixtures")
include(":data:audio-collection")
include(":data:media-collection")
include(":data:artist")
include(":data:artist:test-fixtures")
include(":data:clip")
include(":data:clip:test-fixtures")
include(":data:disk")
include(":data:disk:test-fixtures")
include(":data:image")
include(":data:image:test-fixtures")
include(":data:media")
include(":data:media-asset")
include(":data:media-asset:test-fixtures")
include(":data:sync")
include(":data:track")
include(":data:track:test-fixtures")
include(":database")
include(":database:mapping")
