...
val FakeClip1 = AudioClip(
    id = ClipId("clip-1"),
    title = "Pioneer Spine",
    mediaAsset = FakeAudioAsset1,
...
val FakeClip2 = AudioClip(
    id = ClipId("clip-2"),
    title = "Tiger Tank",
    mediaAsset = FakeAudioAsset2,
    assetOffset = TimeUnit.Samples(0L, 44100),
...
val FakeClip3 = AudioClip(
    id = ClipId("clip-3"),
    title = "Hitch",
    mediaAsset = FakeAudioAsset3,
    assetOffset = TimeUnit.Samples(0L, 44100),
...
val FakeLocalClip1 = FakeClip1.copy(mediaAsset = FakeLocalAudioAsset1)
val FakeLocalClip2 = FakeClip2.copy(mediaAsset = FakeLocalAudioAsset2)
val FakeLocalClip3 = FakeClip3.copy(mediaAsset = FakeLocalAudioAsset3)
