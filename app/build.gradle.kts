...
dependencies {
    ...
    implementation(projects.data.audioCollection)
    implementation(projects.data.mediaCollection)
    ...
    implementation(projects.media.import.impl)
    implementation(projects.media.metadata.impl)
    implementation(projects.media.model)
    implementation(projects.media.store.impl)
